    ...
    const fetchUserData = async () => {
      try {
        ...
        if (!token) {
          ...
          navigate('/organizer-signin'); // Redirect to sign-in if no token is found
          return;
        }
        ...
        if (response.ok) {
          ...
          navigate('/organizer-signin'); // Redirect to sign-in on failure
        }
      } catch (error) {
        console.error('Error fetching user data:', error);
        navigate('/organizer-signin'); // Redirect to sign-in on error
      }
    };
